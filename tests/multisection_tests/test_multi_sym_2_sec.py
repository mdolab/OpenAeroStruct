...
class Test(unittest.TestCase):
    def test(self):
        ...
        assert_near_equal(prob["aero_point_0.surface_perf.CD"][0], 0.0292005, 1e-6)
        assert_near_equal(prob["aero_point_0.surface_perf.CL"][0], 0.299999, 1e-6)
        assert_near_equal(prob["aero_point_0.CM"][1], -0.0733656, 1e-6)
