...
class Test(unittest.TestCase):
    def test(self):
        ...
        #prob.model.add_constraint(point_name +'.CL',upper=0.3,lower=0.3)
        ...
        assert_near_equal(prob["aero_point_0.surface_perf.CD"][0], 0.02919978, 1e-6)
        assert_near_equal(prob["aero_point_0.surface_perf.CL"][0], 0.29999179, 1e-6)
        assert_near_equal(prob["aero_point_0.CM"][1], -0.07335322, 1e-6)
