...
surface = {
    ...
    "sec_sweep":np.array([0.0,0,0.0]), #Wing sweep for each section
    "sec_chord_cp": [np.array([1,1]),np.array([0.2,1.0]),np.array([0.2,1.0])],
    ...
    "sec_ny" : np.array([2,2,2]), #Number of spanwise points for each section
