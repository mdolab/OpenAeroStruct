...
class Test(unittest.TestCase):
    def test(self):
        ...
        surface = {
            ...
            "chord_cp": [np.array([1,1]),np.array([1.0,1.0]),np.array([1.0,1.0])],
        ...
        assert_near_equal(prob["aero_point_0.surface_perf.CD"][0], 0.02179747, 1e-6)
        assert_near_equal(prob["aero_point_0.surface_perf.CL"][0], 0.29999999, 1e-6)
        assert_near_equal(prob["aero_point_0.CM"][1], -0.08302098, 1e-6)
