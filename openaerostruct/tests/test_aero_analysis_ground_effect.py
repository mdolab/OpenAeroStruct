...
class Test(unittest.TestCase):
    ...
    def test_crm_as_ground_effect(self):
        ...
        prob.model.add_design_var('height_agl', lower=12., upper=8000.)
        ...
        # prob['height_agl'] = 10.
        # prob.run_driver()
        # assert_rel_error(self, prob['aero_point_0.CD'][0], 0.09443440276846393, 1e-6)
        # assert_rel_error(self, prob['aero_point_0.CL'][0], 1.570189372488855, 1e-6)
        # assert_rel_error(self, prob['aero_point_0.CM'][1], -5.33013675255012, 1e-6)
        # partials = prob.check_partials(method='cs', out_stream=None)
        # assert_check_partials(partials, rtol=1e-5, atol=1e-5)
        # totals = prob.check_totals(['aero_point_0.CL'],['alpha'],method='cs')
