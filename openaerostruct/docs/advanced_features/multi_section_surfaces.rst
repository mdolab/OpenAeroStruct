...
The constaint-based appraoch is described in a seperate section.
...
Setting up the multi-section goemetry group with the construction-based approach for section joining requires a slightly different inital setup.
...
The remaining steps to analyse the multi-section surface are identical to the constraint-based approach.
...
The multi-section unification component built into the multi-section geometry group being demonstrated here automatically shifts sections outboard/inboard to maintain leading edge coincidence between sections.
